...
def search_transitions(bs, elements, ork, rocket_radius):
    ...
    for idx, transition in enumerate(transitions):
        ...
        bottom_radius = transition.find('aftradius').text if 'auto' in transition.find('aftradius').text else float(transition.find('aftradius').text)
