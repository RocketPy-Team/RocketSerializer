...
def ork_extractor(bs, filepath, output_folder, ork):
    ...
    -------
    dictionary
        Dictionary with the parameters to be used in rocketpy simulations. This
        is equivalent to the parameters.json file generated by the ``ork2json``
        command line tool.
    """
    settings = {}
...
def __init_vectors(bs: BeautifulSoup) -> tuple[list, list[str], list[float]]:
    ...
    time_vector : list[float]
        A list containing the time values of each datapoint.
    """
